"""
OTC-X Frontend Styling
CSS injection and styling utilities for Swiss institutional banking theme
"""
...
def inject_css() -> None:
    """Inject Swiss institutional banking theme CSS into the Streamlit app."""
    st.markdown(
        """
        <style>
