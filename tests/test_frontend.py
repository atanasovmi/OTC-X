...
class TestFrontendImports:
    ...
    def test_import_utils(self):
        from frontend.utils import fmt_chf, fmt_num, fmt_pct, pct_cls, score_badge, _hex_to_rgba
...
class TestFormatUtils:
    ...
    def test_fmt_chf_millions(self):
        from frontend.utils import fmt_chf
    ...
    def test_fmt_num_millions(self):
        from frontend.utils import fmt_num
    ...
    def test_fmt_pct_positive(self):
        from frontend.utils import fmt_pct
    ...
    def test_pct_cls_positive(self):
        from frontend.utils import pct_cls
    ...
    def test_score_badge_clean(self):
        from frontend.utils import score_badge
        badge = score_badge(0)
    ...
    def test_hex_to_rgba(self):
        from frontend.utils import _hex_to_rgba
...
class TestChartGeneration:
    ...
    def test_chart_3d_explorer(self, data):
        import plotly.graph_objects as go
        from frontend.charts import chart_3d_explorer
